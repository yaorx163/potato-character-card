...
import { 冠军实体, 可袭击地点实体, 喽啰池, 母畜实体, 领主实体 } from '../core/entities';
...
type 商品执行效果 = (购买数量: number, 目标: 实体类型 | null, 游戏总控: 游戏总控接口) => 商品执行结果;
...
type 法术执行效果 = (法术倍率: number, 目标: 实体类型 | null, 游戏总控: 游戏总控接口) => 法术执行结果;
...
export function 初始化规则(
  ...
  任务系统.注册任务('潜入劝诱', {
    ...
    执行效果: (执行人, 目标母畜, 游戏总控) => {
      ...
      const 淫乱度 = 执行母畜.获取属性('淫乱度');
      const 自身总雌性价值 = 执行母畜.获取属性('总雌性价值');
      const 目标总雌性价值 = 目标.获取属性('总雌性价值');
  ...
  任务系统.注册任务('生育哥布林冠军', {
    名称: '生育哥布林冠军',
    描述: '母畜生育哥布林冠军',
    前置条件: [执行人 => 执行人.实体类型 === '母畜', 执行人 => (执行人 as 母畜实体).获取属性('剩余雌性价值') >= 100],
  ...
  任务系统.注册任务('生育喽啰', {
    名称: '生育喽啰',
    描述: '母畜生育喽啰',
    前置条件: [执行人 => 执行人.实体类型 === '母畜', 执行人 => (执行人 as 母畜实体).获取属性('剩余雌性价值') >= 10],
  ...
  任务系统.注册任务('献祭', {
    ...
    描述: '献祭母畜以获取魔力',
    行动力占用: _执行人 => 0,
    前置条件: [执行人 => 执行人.实体类型 === '母畜', 执行人 => (执行人 as 母畜实体).获取属性('淫乱度') >= 100],
    执行效果: (执行人, _无, 游戏总控) => {
      const 母畜 = 执行人 as 母畜实体;
  ...
  黑市系统.注册商品('破旧兵刃', {
    ...
    执行效果: (购买数量, 目标喽啰池, 游戏总控) =>
      武装升级效果(10 * 购买数量, '低级武装')(目标喽啰池 as 喽啰池, 游戏总控),
  });
  ...
  黑市系统.注册商品('标准铁剑', {
    ...
    每周限购: Infinity,
    执行效果: (购买数量, 目标喽啰池, 游戏总控) =>
      武装升级效果(4 * 购买数量, '中级武装')(目标喽啰池 as 喽啰池, 游戏总控),
  });
  ...
  黑市系统.注册商品('骑士武装', {
    ...
    每周限购: Infinity,
    执行效果: (购买数量, 目标喽啰池, 游戏总控) =>
      武装升级效果(1 * 购买数量, '高级武装')(目标喽啰池 as 喽啰池, 游戏总控),
  });
  ...
  黑市系统.注册商品('附魔装备', {
    ...
    每周限购: Infinity,
    执行效果: (购买数量, 目标喽啰池, 游戏总控) =>
      武装升级效果(1 * 购买数量, '精英武装')(目标喽啰池 as 喽啰池, 游戏总控),
  });
  ...
  黑市系统.注册商品('祝福水晶', {
    ...
    执行效果: (购买数量, 目标母畜, _游戏总控) => {
      ...
      const 初始总雌性价值 = 母畜.获取属性('总雌性价值');
      const 初始剩余雌性价值 = 母畜.获取属性('剩余雌性价值');
      母畜.修改属性('总雌性价值', 增量);
      母畜.修改属性('剩余雌性价值', 增量);
      ...
      return {
        ...
        目标: 母畜,
        变化: {
          总雌性价值: [初始总雌性价值, 母畜.获取属性('总雌性价值')],
          剩余雌性价值: [初始剩余雌性价值, 母畜.获取属性('剩余雌性价值')],
        },
      };
    },
  });
