...
const 可袭击地点类型配置 = {
  ...
  城市: {
    ...
    位置类型: ['王国边境', '内陆', '沿海', '要塞区'],
    潜在目标身份池: ['贵族', '城主之女', '女骑士', '低阶冒险者', '见习法师'],
    稀有身份概率: 0.25,
    稀有身份池: ['高阶法师', '女将军', '大贵族'],
  },
...
export { 可袭击地点类型配置, 种族权重配置, 年龄范围配置, 难度系数配置, 护卫战力配置, 初始化可袭击地点公式 };

export default 可袭击地点类型配置;
