...
import { 冠军实体, 母畜实体, 可袭击地点实体, 领主实体 } from './entities.js';
...
class 母畜工厂 {
  ...
  创建已捕获(配置 = {}) {
    ...
    母畜.捕获状态 = 母畜实体.捕获状态.已捕获;
    母畜.捕获回合 = 配置.捕获回合 || null;
...
class 可袭击地点工厂 {
  ...
  生成地点名称(类型) {
    ...
    const 随机取 = arr => arr[Math.floor(Math.random() * arr.length)];
...
export { 冠军工厂, 工厂管理器, 母畜工厂, 可袭击地点工厂, 领主工厂 };
