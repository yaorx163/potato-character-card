...
export function 初始化任务法术市场(
  ...
  任务系统.注册任务('调教', {
    ...
    执行效果: (执行人, 目标母畜, _游戏总控) => {
      ...
      return {
        ...
        目标: 母畜,
        变化: { 臣服度: [初始值, 新值] },
        信息: `${冠军.获取属性('姓名')} 对 ${母畜.获取属性('姓名')} 进行了调教，其臣服度增加了 ${增量} 点`,
      };
    },
  });
  ...
  任务系统.注册任务('劝慰', {
    ...
    前置条件: {
      类型: 执行人 => 执行人.实体类型 === '母畜',
      臣服度: 执行人 => (执行人 as 母畜实体).获取属性('臣服度') >= 50,
    },
    行动力占用: _执行人 => 1,
    执行效果: (执行人, 目标母畜, _游戏总控) => {
      ...
      return {
        ...
        目标: 目标,
        变化: { 臣服度: [初始值, 新值] },
        信息: `${执行母畜.获取属性('姓名')} 对 ${目标.获取属性('姓名')} 进行了劝慰，其臣服度增加了 ${增量} 点`,
      };
    },
  });
    ...
    执行效果: (执行人, 目标地点, _游戏总控) => {
      ...
      if (Math.random() > 成功率) {
        return {
          ...
          执行人: 冠军,
          目标: 地点,
          信息: `${冠军.获取属性('姓名')} 尝试侦察 ${地点.获取属性('地点名称')}，但是失败了`,
        };
      }
      ...
      return {
        ...
        执行人: 冠军,
        目标: 地点,
        信息: `${冠军.获取属性('姓名')} 侦察了 ${地点.获取属性('地点名称')}，成功发现了 ${被侦察母畜列表.length} 个值得关注度女性`,
        变化: { 侦察进度: [初始进度, 当前进度] },
        已侦察母畜: 被侦察母畜列表,
      };
    },
  ...
  任务系统.注册任务('潜入侦察', {
    ...
    前置条件: {
      类型: 执行人 => 执行人.实体类型 === '母畜',
      臣服度: 执行人 => (执行人 as 母畜实体).获取属性('臣服度') >= 75,
    },
    行动力占用: _执行人 => 1,
    执行效果: (执行人, 目标地点, _游戏总控) => {
      ...
      if (Math.random() > 成功率) {
        return {
          ...
          执行人: 母畜,
          目标: 地点,
          信息: `${母畜.获取属性('姓名')} 尝试潜入 ${地点.获取属性('地点名称')}，但是失败了`,
        };
      }
      ...
      return {
        ...
        变化: { 侦察进度: [初始进度, 当前进度] },
        已侦察母畜: 被侦察母畜列表,
        信息: `${母畜.获取属性('姓名')} 潜入 ${地点.获取属性('地点名称')}，成功发现了 ${被侦察母畜列表.length} 个值得关注度女性`,
      };
    },
  });
  ...
  任务系统.注册任务('潜入劝诱', {
    ...
    前置条件: {
      类型: 执行人 => 执行人.实体类型 === '母畜',
      臣服度: 执行人 => (执行人 as 母畜实体).获取属性('臣服度') >= 90,
    },
    行动力占用: _执行人 => 1,
    执行效果: (执行人, 目标母畜, 游戏总控) => {
      const 执行母畜 = 执行人 as 母畜实体;
      ...
      const 潜入成功率 = 执行母畜.获取效率('魅力') * 淫乱度惩罚
      const 劝说成功率 = 魅力差 * 魅力差 / 4000;
      const 随机结果 = Math.random();

      if (Math.random() > 潜入成功率) {
        return {
          成功: false,
          类型: '潜入劝诱',
          执行人: 执行母畜,
          目标: 目标,
          信息: `${执行母畜.获取属性('姓名')} 尝试潜入 ${目标.获取属性('姓名')}，但是失败了`,
        };
      }
      if (Math.random() > 劝说成功率) {
        return {
          成功: false,
          类型: '潜入劝诱',
          执行人: 执行母畜,
          目标: 目标,
          信息: `${执行母畜.获取属性('姓名')} 潜入了 ${目标.获取属性('姓名')}，但没有说服 ${目标.获取属性('姓名')}`,
        };
      }
      ...
      return {
        ...
        目标: 目标,
        已获取母畜: [目标],
        信息: `${执行母畜.获取属性('姓名')} 潜入 ${目标.获取属性('姓名')}，成功劝诱了 ${目标.获取属性('姓名')}`,
      };
    },
  });
  任务系统.注册任务('生育哥布林冠军', {
    ...
    前置条件: {
      类型: 执行人 => 执行人.实体类型 === '母畜',
      臣服度: 执行人 => (执行人 as 母畜实体).获取属性('剩余生育力') >= (执行人 as 母畜实体).生育冠军消耗(),
    },
    ...
    执行效果: (执行人, _无, 游戏总控) => {
      ...
      if (冠军) {
        ...
        return {
          ...
          已获取冠军: [冠军],
          信息: `${母畜.获取属性('姓名')} 生育了一个哥布林冠军: ${冠军.获取属性('姓名')}`,
        };
      }
  ...
  任务系统.注册任务('生育喽啰', {
    ...
    前置条件: {
      类型: 执行人 => 执行人.实体类型 === '母畜',
      生育力: 执行人 => (执行人 as 母畜实体).获取属性('剩余生育力') >= (执行人 as 母畜实体).生育喽啰消耗(),
    },    
    ...
    执行效果: (执行人, _无, 游戏总控) => {
      ...
      const 数量 = min(10, floor(价值 / 母畜.生育喽啰消耗()));
  ...
  任务系统.注册任务('提振士气', {
    ...
    执行效果: (执行人, _无, 游戏总控) => {
      ...
      return {
        ...
        信息: `将 ${母畜.获取属性('姓名')} 提供给哥布林小弟们使用，士气提升了 ${增量}`,
      };
    },
  });
  ...
  任务系统.注册任务('泌乳', {
    ...
    前置条件: {
      类型: 执行人 => 执行人.实体类型 === '母畜',
      淫乱度: 执行人 => (执行人 as 母畜实体).获取属性('淫乱度') >= 25,
    },   
  ...
  任务系统.注册任务('献祭', {
    ...
    前置条件: {
      类型: 执行人 => 执行人.实体类型 === '母畜',
      淫乱度: 执行人 => (执行人 as 母畜实体).获取属性('淫乱度') >= 75,
    },   
    执行效果: (执行人, _无, 游戏总控) => {
      const 母畜 = 执行人 as 母畜实体;
  ...
  黑市系统.注册商品('祝福水晶', {
    ...
    执行效果: (购买数量, 目标母畜, _游戏总控) => {
      ...
      return {
        ...
        信息: `对 ${母畜.获取属性('姓名')} 使用了祝福水晶，生育力提高了 ${增量}`,
      };
    },
  });
  ...
  黑市系统.注册商品('净化水晶', {
    ...
    执行效果: (购买数量, 目标母畜, _游戏总控) => {
      ...
      return {
        ...
        目标: 母畜,
        变化: { 淫乱度: [初始淫乱, 新值] },
        信息: `对 ${母畜.获取属性('姓名')} 使用了净化水晶，淫乱度降低了 ${10 * 购买数量}`,
      };
    },
  });
  ...
  法术系统.注册法术('魔眼侦察', {
    ...
    执行效果: (法术倍率, 目标地点, _游戏总控) => {
      ...
      return {
        ...
        目标: 地点,
        变化: { 侦察进度: [初始侦察进度, 新值] },
        信息: `对 ${地点.地点名称} 释放了侦察法术，侦察进度增加了 ${20 * 法术倍率}`,
  ...
  法术系统.注册法术('意志粉碎', {
    ...
    执行效果: (法术倍率, 目标母畜, _游戏总控) => {
      ...
      return {
        ...
        目标: 母畜,
        变化: { 臣服度: [初始臣服, 新值] },
        信息: `对 ${母畜.获取属性('姓名')} 使用了意志粉碎法术，臣服度增加了 ${10 * 法术倍率}`,
      };
    },
  });
  ...
  法术系统.注册法术('孕力回复', {
    ...
    执行效果: (法术倍率, 目标母畜, _游戏总控) => {
      ...
      return {
        ...
        目标: 母畜,
        变化: { 剩余生育力: [初始剩余生育力, 新值] },
        信息: `对 ${母畜.获取属性('姓名')} 使用了孕力回复法术，生育力恢复了 ${50 * 法术倍率}`,
      };
    },
  });
