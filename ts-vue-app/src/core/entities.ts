...
import type {武装等级, 属性约束配置, 元数据配置, 实体初始数据, 实体基类属性Schema, 领主属性Schema, 冠军属性Schema, 母畜属性Schema, 可袭击地点属性Schema, 事件处理器, 冠军初始数据} from '../types/index';
...
export { 冠军实体, 可袭击地点实体, 喽啰池 as 喽啰池, 实体基类, 母畜实体, 领主实体 };
