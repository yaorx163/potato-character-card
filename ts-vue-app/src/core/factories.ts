...
import type { 冠军初始数据, 姓名池配置, 属性系数, 冠军工厂配置, 生育选项, 生育结果, 属性预估范围, 数值范围, 地点名称池, 地点类型配置数据, 地点创建配置, 可袭击地点工厂配置, 生育效率表, 运行时配置接口, 
...
class 冠军工厂 {
  ...
  从母畜生育(母畜: 母畜实体, 选项: 生育选项 = {}): 生育结果 {
    ...
    const 身份系数 = this.生育效率表.身份系数表.get(母畜身份) ?? { 力量: 1.0, 敏捷: 1.0, 智力: 1.0 };
    const 种族系数 = this.生育效率表.种族系数表.get(母畜种族) ?? { 力量: 1.0, 敏捷: 1.0, 智力: 1.0 };
